...
// InvokeHello
func (setup *FabricSetup) InvokeVehicule(value string) (string, error) {

	// Prepare arguments
	var args []string
	args = append(args, "invoke")
	args = append(args, "invoke")
	args = append(args, "vehicule")
	...
	transientDataMap["result"] = []byte("Transient data in Liste Vihicule invoke")
